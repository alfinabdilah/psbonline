...
<form action="authenticationadmin.php" method="post">
  <div class="form-group">
    <input type="text" class="form-control" name="emailadmin" placeholder="Masukan Email">
  </div><br>
  <div class="form-group">
    <input type="password" class="form-control" name="passwordadmin" placeholder="Masukan Password">
  </div><br>
 <center>
    <button type="submit" name="masuk" class="btn btn-dark">Masuk</button><br><br>
 </center>
</form>
